...
################################################################################
## Form generated from reading UI file 'oneboard_responsive.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.reset.setFont(font3)

        self.gridLayout.addWidget(self.reset, 5, 0, 1, 3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.reset.setText(QCoreApplication.translate("MainWindow", u"RESTART", None))
    # retranslateUi
